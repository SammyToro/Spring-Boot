...
public class ToDoClient {
    ...
    public ToDo add(ToDo toDo){
        ...
        ResponseEntity<ToDo> response = this.restTemplate.exchange(
            RequestEntity.post(uriComponents.toUri()).body(toDo), new ParameterizedTypeReference<ToDo>() {});
    ...
    public ToDo findById(String id){
        ...
        ResponseEntity<ToDo> response = this.restTemplate.exchange(
            RequestEntity.get(uriComponents.toUri()).accept(MediaTypes.HAL_JSON).build(), new ParameterizedTypeReference<ToDo>() {});
    ...
    public Collection<ToDo> findAll(){
        ...
        ParameterizedTypeReference<CollectionModel<ToDo>> typeRefDevices = new ParameterizedTypeReference<CollectionModel<ToDo>>() {};
        
        CollectionModel<ToDo> toDos = tb.toObject(typeRefDevices);
